...
# Data flow: Eventstream → rti_all_events → adt_events (via KQL update policy or backfill above)
df_adt = None
...
for _attempt in range(1, _max_wait + 1):
    ...
    if _cnt > 0:
        ...
        print(f"  [{_attempt}/{_max_wait}] adt_events is empty — waiting for update policy...")
